...
* Allows buyers to edit shopping cart via AJAX popup
* Support AJAX popup in the shopping cart page for a quick edit
* Ability to update product quantities and product options via AJAX popup
* Support  increment/ decrements buttons and inputs to update quantities on the cart page 
* Work with simple, downloadable, virtual, configurable, and bundle product types
* Support customization options, and swatches in configurable products 
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/cart-edit-f.png">
